  ...
  return (
    <Card className="border border-gray-200 shadow-sm rounded-md overflow-hidden w-full">
      <div className="border-b border-gray-200">
        <div className="grid grid-cols-5 bg-[#49495b] text-white text-xs p-3">
          ...
          >
            ...
            <div className="p-3 px-3 flex items-center justify-center">
              <Button 
                variant="outline" 
                size="sm" 
                className="text-xs border-[#353acd] text-[#353acd] hover:bg-[#353acd]/10 h-7 px-3 flex items-center gap-1"
