          ...
          <div className="ml-2 pl-4 border-l-2 border-[#1963ff]">
            <ul className="space-y-1 py-1">
              ...
              <li>
                <a 
                  href="#" 
                  onClick={(e) => { e.preventDefault(); setActiveCategory("email-alerts"); }}
                  className={`flex items-center text-xs py-1.5 px-2 rounded transition-colors duration-150 group
                    ${activeCategory === "email-alerts" ? "bg-gray-200 text-[#1963ff] font-medium" : "text-gray-700 hover:bg-gray-100"}`}
                >
                  <span className="mr-1 text-[#1963ff]">•</span>
              ...
              <li>
                <a 
                  href="#" 
                  onClick={(e) => { e.preventDefault(); setActiveCategory("enable-integration"); }}
                  className={`flex items-center text-xs py-1.5 px-2 rounded transition-colors duration-150 group
                    ${activeCategory === "enable-integration" ? "bg-gray-200 text-[#1963ff] font-medium" : "text-gray-700 hover:bg-gray-100"}`}
                >
                  <span className="mr-1 text-[#1963ff]">•</span>
